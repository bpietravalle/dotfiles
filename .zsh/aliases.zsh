...
alias wjs='cd $HOME/dev/webiny-js' 
alias wex='cd $HOME/dev/webiny-examples' 
alias rvmhub='cd $HOME/projects/rvm-hub' 
alias lgsites='cd $HOME/projects/lead-gen-sites' 
